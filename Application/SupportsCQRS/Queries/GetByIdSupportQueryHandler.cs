...
{
   public class GetByIdSupportQueryHandler : IRequestHandler<GetByIdSupportQueryRequest, SupportDto>
    {
        ...
        public async Task<SupportDto> Handle(GetByIdSupportQueryRequest request, CancellationToken cancellationToken)
        {
