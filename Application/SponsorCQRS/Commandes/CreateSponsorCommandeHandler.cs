...
{
    public class CreateSponsorCommandeHandler : IRequestHandler<CreateSponsorCommandeRequest, SponsorCreateDto>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public CreateSponsorCommandeHandler(IHttpContextAccessor httpContextAccessor, IUnitOfWork unitOfWork,IMapper mapper,IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<SponsorCreateDto> Handle(CreateSponsorCommandeRequest request, CancellationToken cancellationToken)
        {
